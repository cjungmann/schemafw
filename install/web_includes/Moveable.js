var Moveable = {
   process_event : function(e,t) { return Moveable._process(e,t); },
   ...
   _process : function(e,t)
   {
         ...
         switch(e.type)
         {
            ...
            if (class_includes(t,"Moveable"))
            {
               if ((o=get_object_from_handle(t)))
               {
                  ...
                  Events.add_event("mousemove",_int_process);
            ...
            if ((o=object_get()))
            {
               ...
               if (!(os_diff.left==0 && os_diff.right==0))
               {
                  ...
                  {
                     Events.remove_event("mousemove", _int_process);
      ...
      Moveable._process = _int_process;
      return _int_process(e,t);
   }
};
