...
<xsl:stylesheet
  ...
  <xsl:variable name="jslist_sfw_debug">classes dpicker Events Dialog Moveable XML sfw_0 sfw_doc sfw_tbase sfw_calendar sfw_debug sfw_dom sfw_form sfw_form_view sfw_ulselect sfw_mixed_view sfw_onload sfw_table sfw_assoc sfw_lookup sfw_isotable sfw_iltable</xsl:variable>
